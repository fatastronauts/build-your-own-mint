...
exports.fetchTransactions = async function(isPublic = true) {
        ...
        .catch(err => {
          console.error(
            'Fetching transactions failed:\n' +
              JSON.stringify({ err, account: isPublic ? account : 'PRIVATE' }),
          );
          process.exit(1);
        });
    }),
...
exports.fetchBalances = async function(isPublic = true) {
